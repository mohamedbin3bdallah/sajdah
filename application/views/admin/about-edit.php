                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('aboutus/editabout/'.$about->abid, $attributes);
					?>
                    <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
					  ...
					  <!--<div class="form-group">
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							/*if(isset($about->abimg) && $about->abimg != '' && file_exists($this->config->item('about_folder').$about->abimg))
							{ 
								?><img src="<?php echo base_url().$this->config->item('about_folder').$about->abimg; ?>" class="img-responsive" style="max-width:150px;max-height:150px;"/><?php
								$data = array(
									'oldimg'  => $about->abimg
								);
