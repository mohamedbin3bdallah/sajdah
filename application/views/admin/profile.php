			...
			<div class="x_title">
			  ...
			  <div class="col-md-3 col-md-push-9 col-sm-3 col-sm-push-9 col-xs-12 profile_left">
				<div class="profile_img">
					<div id="crop-avatar">
						<!-- Current avatar -->
						<img class="img-responsive" width="100%" style="max-height:555px;" src="<?php if($this->loginuser->uimage != '' && file_exists($this->config->item('users_folder').$this->loginuser->uimage)) echo base_url().$this->config->item('users_folder').$this->loginuser->uimage; else echo base_url().$this->config->item('users_folder').'user.png'; ?>" alt="<?php echo $this->loginuser->username; ?>" title="<?php echo $this->loginuser->username; ?>">
                    </div>
                </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<table id="datatable-buttons" class="table">
                      <thead>
                        <tr>
                          <th width="97%"><?php echo lang('records'); ?></th>
						  <th width="3%"><?php //echo lang('records'); ?></th>
                        </tr>
                      </thead>
                      <tbody>
					  <?php foreach($nots as $not)	{ ?>
                        <tr>
						  ...
						  <td width="3%"><?php echo date('h:i:s',$not->time); if(date('H', $not	->time) < 12) echo ' '.lang('am'); else echo ' '.lang('pm'); ?></td>
                        </tr>
					  <?php } ?>
                      </tbody>
                    </table>
